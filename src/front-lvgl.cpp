...
#error "no useful VOORKANT_LVGL_* found"
  ...
  */
  ...
  uielements.push_back(std::make_unique<UIApexCard>(_backend, "dashboard-charts", 1, cont_row)); // FIXME this is hardcoded to only render the first chart from the first user panel, currently even ignoring the string,int argument here
  int i = 0;
  while (true) {
