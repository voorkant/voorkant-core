...
#include "mdimap.hpp" // FIXME: should live in uicomponents/ maybe
#include <memory>
...
#error "no useful VOORKANT_LVGL_* found"
  ...
  */
  ...
  lv_label_set_text(left_btn_txt, voorkant::mdi::name2id.at("arrow_left").data());
  ...
  lv_label_set_text(right_btn_txt, voorkant::mdi::name2id.at("arrow_right").data());
